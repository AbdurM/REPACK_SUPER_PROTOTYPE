...
function App() {
  ...
  // ---- Uncomment the below if your want to fetch the config remotely from Raven ----
  ...
  //       throw new Error("Response is not an array or is");
  //     }
    ...
    return (
      <View style={styles.container}>
        <Suspense fallback={<Text>Loading...</Text>}>
          <NavigationContainer>
            <BottomTabNavigator config={config}/>
