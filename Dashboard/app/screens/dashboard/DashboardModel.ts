...
const lineData1 = [
  { value: 10, label: Constants.months[0] }, // Jan
  { value: 20, label: Constants.months[1] }, // Feb
  { value: 15, label: Constants.months[2] }, // Mar
  { value: 30, label: Constants.months[3] }, // Apr
  { value: 25, label: Constants.months[4] }, // May
  { value: 35, label: Constants.months[5] }, // Jun
  { value: 40, label: Constants.months[6] }, // Jul
  { value: 40, label: Constants.months[7] }, // Aug
];

const lineData2 = [
  { value: 5, label: Constants.months[0] }, // Jan
  { value: 25, label: Constants.months[1] }, // Feb
  { value: 10, label: Constants.months[2] }, // Mar
  { value: 20, label: Constants.months[3] }, // Apr
  { value: 15, label: Constants.months[4] }, // May
  { value: 30, label: Constants.months[5] }, // Jun
  { value: 38, label: Constants.months[6] }, // Jul
];
